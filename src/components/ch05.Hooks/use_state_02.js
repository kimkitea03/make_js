...
function App() {
    ...
    const [modleName, setModelName] = useState('아반떼(avante)');//한글 이름과 함꼐 보여줄 state
    ...
    return (
        <div className="App">
            ...
            <p>
                <span style={{ color: color, fontWeight: 'bolder' }}>{color}</span> 색상의 {year}년산 {modleName}모델 <br /> {comment}
            </p>
            <br /><br />
