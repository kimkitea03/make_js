...
function App() {
    ...
    //새롭게 추가되는 회원의 id 번호를 기억하기 위한 state 입니다.
    const [nextId, setNextId] = useState(0);

    const AddMember = (event) => {
        //members 배열에서 id 항목슬만 추출합니다.
        // 이결과 역시 객체로 되어 있는데, ... 연산자를 사용하여 스칼라 데이터로 만든 다음
