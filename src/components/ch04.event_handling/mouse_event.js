        ...
        <div className="App">
            ...
            <table>
                <tbody>
                    <tr>
                        <td>
                            <img src={`${image_path}/french_baguette_01_bigsize.png`} alt="프렌치 바게트" width={image_small_size} height={image_small_size} onMouseMove={MouseMoveEvent} />
                        </td>
                    ...
                    <tr>
                        <td>
                            <img src={`${image_path}/ciabatta_07.png`} alt="치아바타" width={image_small_size} height={image_small_size} onMouseMove={MouseMoveEvent} />
                        </td>
                    </tr>
                </tbody>
            </table>
